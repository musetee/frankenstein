...
def extract_patient_and_slice_info(file_path):
    ...
    parts = filename.split('_')
    patient_id = f'{parts[0]}_{parts[1]}_{parts[2]}'  # Assuming the patient ID format like '1PC082'
...
mode = 'for_root' # 'for_single'
if mode == 'for_single':
    # Set the path to the folder containing your slices
    # Set the path to the folder containing your slices
    folder_path = r'D:\Project\seg2med_Project\synthrad_results\results_all_eval\20241125_2234_Infer_ddpm2d_seg2med_anika_512_all\saved_outputs'
    ...
    root_path = r'D:\Project\seg2med_Project\synthrad_results\results_all_eval\1128results\1128anika'
    folder_list = [
        '20241128_1337_Infer_cycle_gan_anika',
        '20241128_1340_Infer_pix2pix_anika',
        '20241128_1347_Infer_AttentionUnet_anika',
                ]
