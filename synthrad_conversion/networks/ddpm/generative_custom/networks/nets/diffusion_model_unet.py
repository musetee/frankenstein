...
class DownBlock(nn.Module):
    ...
    Args:
        ...
        norm_num_groups: number of groups for the group normalization.
        norm_eps: epsilon for the group normalization.
        add_downsample: if True add downsample block. is True if not final block.
...
class UpBlock(nn.Module):
    ...
    def forward(
        ...
        for resnet in self.resnets:
            ...
            #print("shape of hidden_states, res_hidden_states:",hidden_states.shape, res_hidden_states.shape)
...
class DiffusionModelUNet(nn.Module):
    ...
    def forward(
        ...
        for upsample_block in self.up_blocks:
            ...
            #print("h.shape, res_samples.shape:", len(h), len(res_samples))
